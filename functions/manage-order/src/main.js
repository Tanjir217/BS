...
// Appwrite Functions receive these values as Function environment variables.
// The project uses the VITE_APPWRITE_* naming convention, so that convention
// is the primary name here. APPWRITE_* remains supported for compatibility.


const DATABASE_ID = getEnv("VITE_APPWRITE_DATABASE_ID", "APPWRITE_DATABASE_ID");
const PRODUCTS_TABLE_ID = getEnv("VITE_APPWRITE_PRODUCTS_TABLE_ID", "APPWRITE_PRODUCTS_TABLE_ID");
const ORDERS_TABLE_ID = getEnv("VITE_APPWRITE_ORDERS_TABLE_ID", "APPWRITE_ORDERS_TABLE_ID");
const ORDER_ITEMS_TABLE_ID = getEnv("VITE_APPWRITE_ORDER_ITEMS_TABLE_ID", "APPWRITE_ORDER_ITEMS_TABLE_ID");
const RETURN_REQUESTS_TABLE_ID = getEnv("VITE_APPWRITE_RETURN_REQUESTS_TABLE_ID", "APPWRITE_RETURN_REQUESTS_TABLE_ID");
const DELIVERY_SHIPMENTS_TABLE_ID = getEnv("VITE_APPWRITE_DELIVERY_SHIPMENTS_TABLE_ID", "APPWRITE_DELIVERY_SHIPMENTS_TABLE_ID");
const CUSTOMER_ADDRESSES_TABLE_ID = getEnv("VITE_APPWRITE_CUSTOMER_ADDRESSES_TABLE_ID", "APPWRITE_CUSTOMER_ADDRESSES_TABLE_ID");
const CUSTOMERS_TABLE_ID = getEnv("VITE_APPWRITE_CUSTOMERS_TABLE_ID", "APPWRITE_CUSTOMERS_TABLE_ID");
const MANAGEMENT_TEAM_ID = getEnv("VITE_APPWRITE_MANAGEMENT_TEAM_ID", "APPWRITE_MANAGEMENT_TEAM_ID");
...
function assertConfigured(action) {
  ...
  if (CUSTOMER_ADDRESS_ACTIONS.has(action)) {
    required.VITE_APPWRITE_CUSTOMER_ADDRESSES_TABLE_ID = CUSTOMER_ADDRESSES_TABLE_ID;

    if (action === "ensure_customer_profile") {
      required.VITE_APPWRITE_CUSTOMERS_TABLE_ID = CUSTOMERS_TABLE_ID;
    }
  } else {
    required.VITE_APPWRITE_PRODUCTS_TABLE_ID = PRODUCTS_TABLE_ID;
    required.VITE_APPWRITE_ORDERS_TABLE_ID = ORDERS_TABLE_ID;
    required.VITE_APPWRITE_ORDER_ITEMS_TABLE_ID = ORDER_ITEMS_TABLE_ID;
    required.VITE_APPWRITE_MANAGEMENT_TEAM_ID = MANAGEMENT_TEAM_ID;
  }
